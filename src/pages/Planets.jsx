            ...
            <div className="gridItemData">
                ...
                <div className="gridItemContent">
                    ...
                    {infobarOpen && <Infobar category={'Character'}
                        ...
                        label2="Climate" label2Content={props.climate}
                        label3="Gravity" label3Content={props.gravity}
    ...
    return (
        <div className="listView">
            ...
            </div>
            {
                ...
                data.map((item) => (
                    <ListItem name={item.name} climate={item.climate}
...
const Planets = () => {
    ...
    return (
        <div className="page">
            <Sidebar category="planets" data={data} />
            <div className="pageContent">
                <div className="pageCategory">
                    <h1 className="pageCategoryTitle">Planets</h1>
