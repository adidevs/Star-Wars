            ...
            <div className="gridItemData">
                ...
                <div className="gridItemContent">
                    ...
                    {infobarOpen && <Infobar category={'Character'}
                        ...
                        label2="Classification" label2Content={props.classification}
                        label3="Lifespan" label3Content={props.average_lifespan}
    ...
    return (
        <div className="listViewItem">
            <div className="listItemData">
                ...
                <div>{props.average_lifespan}</div>
    ...
    return (
        <div className="listView">
            ...
            </div>
            {
                ...
                data.map((item) => (
                    <ListItem name={item.name} classification={item.classification}
...
const Species = () => {
    ...
    return (
        <div className="page">
            <Sidebar category="species" data={data} />
            <div className="pageContent">
                <div className="pageCategory">
                    <h1 className="pageCategoryTitle">Species</h1>
