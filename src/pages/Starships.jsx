            ...
            <div className="gridItemData">
                ...
                <div className="gridItemContent">
                    ...
                    {infobarOpen && <Infobar category={'Character'}
                        ...
                        label3="Hyperdrive Rating" label3Content={props.hyperdrive_rating}
    ...
    return (
        <div className="listViewItem">
            <div className="listItemData">
                ...
                <div>{props.model}</div>
                <div>{props.hyperdrive_rating}</div>
...
const Starships = () => {
    ...
    return (
        <div className="page">
            <Sidebar category="starships" data={data} />
            <div className="pageContent">
                <div className="pageCategory">
                    <h1 className="pageCategoryTitle">Starships</h1>
